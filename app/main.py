...
def create_application(
    ...
    # Candidate service (default fallback for issue comments / assignments)
...
def create_production_app() -> FastAPI:
    """Compose the real GitHub, storage, and candidate analysis dependencies from the environment.
    ...
    return create_application(
        webhook_secret=github_config.webhook_secret,
        candidate_service=candidate_service,
        start_worker=True,
    )
